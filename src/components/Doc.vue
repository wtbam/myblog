...
:root {
  ...
  --theme-muted: #F6F7F8;
  --theme-border: #EBEDF0;
  --theme-muted-blue: #d4e7fd;

  --theme-link: #076DDD;
  --theme-font-general: #171E27;
  ...
  --monospace: "IBMPlexMono", "FiraCode", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas,
...
h6::before {
  content: '';
  /* Required content property for pseudo-elements */
  position: absolute;
  left: 0;
  top: 50%;
...
:root {
  ...
  --code-tag: rgb(198, 120, 221);
  --code-variable: rgb(97, 175, 239);
  --code-operator: var(--theme-600);
  --code-comment: rgb(126, 132, 142);
  --code-bracket: rgb(171, 178, 191);
...
#write .cm-s-inner {
  ...
  --code-citation: var(--code-citation); */

  --code-neutral: rgb(126, 132, 142);
  --code-cursor: var(--theme-50);
  --code-string: #98C379;
  --code-number: rgb(209, 154, 102);
  --code-tag: #E06C75;
